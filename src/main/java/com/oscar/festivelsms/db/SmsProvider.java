...
public class SmsProvider extends ContentProvider {
    private static final String AUTHORITY = "com.oscar.festivelsms.SmsProvider";
    public static final Uri URI_SMS_ALL = Uri.parse("content://" + AUTHORITY + "/sms");

    private static UriMatcher mUriMather;
    ...
    static {
        ...
        mUriMather.addURI(AUTHORITY, "sms", SMS_ALL);
        mUriMather.addURI(AUTHORITY, "sms/#", SMS_ONE);
    }
    ...
    public boolean onCreate() {
        mHelper = SmsDBHelper.getInstance(getContext());
        return true;
    }
